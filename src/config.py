...
class Config:
    ...
    feishu_doc_retention_days: int = 0  # 飞书云文档保留天数（0=不自动删除）
    ...
    def _load_from_env(cls) -> 'Config':
        ...
        return cls(
            ...
            feishu_doc_retention_days=parse_env_int(os.getenv('FEISHU_DOC_RETENTION_DAYS'), 0, field_name='FEISHU_DOC_RETENTION_DAYS', minimum=0),
